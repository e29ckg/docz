...
/**
 * UserdepnameController implements the CRUD actions for UserDepName model.
 */
class UserdepnameController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        if (($model = UserDepName::findOne($id)) !== null) {
            return $model;
        }
